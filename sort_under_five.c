...
static int		ft_sort_perf_three(t_stacks *stack, t_list **instructions)
{
...
{
	if (stack->a_count == 3 && is_sorted(stack->a, 3)  == 0)
	{ 
		if (ft_sort_perf_three(stack, instructions) == 0)
			return (0);
	}
	if (ft_sort_two(stack, instructions) == 0)
		return (0);
	...
	if (stack->a[2] < stack->a[1] && stack->a[2] < stack->a[0])
		ft_smart_rotate_a(1, stack, instructions);
    if (stack->a[2] < stack->a[1] || stack->a[2] < stack->a[0])
    {
...
int		ft_sort_four(t_stacks *stack, t_list **instructions)
{
	...
	if (ft_smart_rotate_a(2, stack, instructions) == 0)
		return (0);
	if (ft_sort_two(stack,instructions) == 0)
		return (0);
	}
...
int    ft_sort_five(t_stacks *stack, t_list **instructions)
{
	...
	while ((stack->a_count > 3 && stack->a_count < 6) && rev-- != 0)
	{
		if (ft_move_and_save("ra", stack, instructions) == 0)
			return (0);
	}
	while ((stack->a_count >= 7 && rev-- > 0))
	{
		if (ft_move_and_save("rra", stack, instructions) == 0)
			return (0);
	}
...
int		ft_sort_to_five(t_stacks *stack, t_list **instructions)
{
	...
	if (len == 3)
		if (ft_sort_three(stack, instructions) == 0)
			return (0);
	if  (len == 4)
		if (ft_sort_four(stack, instructions) == 0)
			return (0);
	if (len == 5)
		if (ft_sort_five(stack, instructions) == 0)
			return (0);
	return (1);
}
